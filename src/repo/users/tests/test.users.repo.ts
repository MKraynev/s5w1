...
describe(`${UsersRepoService.name}: read user`, () => {
    ...
    it('Get user by login', async () => {
        ...
        let createUserEntity_1 = new UserControllerRegistrationEntity("userqwe", "special@mail.com", "123123");
        let createUserEntity_2 = new UserControllerRegistrationEntity("user", "notspecial@mail.com", "123123")
        let createUserEntity_3 = new UserControllerRegistrationEntity("bob", "bob@mail.com", "123123")
        let createUserEntity_4 = new UserControllerRegistrationEntity("alice", "alice@mail.com", "123123")
        ...
        let findUsersByLoginByEmail = await usersRepoService.ReadManyByLoginByEmail(createUser_2.login, createUser_3.email);

        expect(findUsersByLoginByEmail).toMatchObject([createUser_3, createUser_2]);
    })
})