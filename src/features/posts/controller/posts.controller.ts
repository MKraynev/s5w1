...
export class PostsController {
  ...
  async GetPostById(
    ...
    await _WAIT_();
    let post = await this.commandBus.execute<PostServiceGetPostByIdCommand, PostInfo>(
  ...
  async SaveComment(
    ...
    let comment = await this.commandBus.execute<PostServiceSavePostCommentCommand, CommentInfo>(
  ...
  async PutLike(
    ...
    let savedLikestatus = await this.likeRepo.SetUserLikeForPost(tokenLoad.id, likeData.likeStatus, id);
