...
describe(`UsersRepoService ReadLike`, () => {
    ...
    it("Create 3 like users, expext receive 3 users", async () => {
        ...
        let user_1 = new UserControllerRegistrationEntity("userLogin", "lk@mail.com", "123123");
        let user_2 = new UserControllerRegistrationEntity("userLog", "ba@mail.com", "123123");
        let user_3 = new UserControllerRegistrationEntity("userLogi", "qe@mail.com", "123123");
        let user_4 = new UserControllerRegistrationEntity("pupu", "zi@mail.com", "123123");
        ...
        let users = await usersRepoService.ReadManyLikeByLoginByEmail("user", undefined);

        expect(users.countAll).toEqual(3);
        expect(users.foundusers).toEqual([createdUser_3, createdUser_2,createdUser_1 ]);
