...
export class EmailService {
    ...
    public async SendPasswordRecoveryMail(sendTo: string, confirmCode: string, recoveryPath: string) {
        let result: EmailServiceExecutionStatus = { status: EmailSendStatus.Sent, error: undefined };
    ...
    private _PASSWORD_RECOVERY_FORM(sendTo: string, confirmCode: string, recoveryPathPath: string) {
        let result: MailServiceEntity = {
            to: sendTo,
            from: `"SAMURAI 🥷"<${MAIL_LOGIN}@gmail.com>`,
