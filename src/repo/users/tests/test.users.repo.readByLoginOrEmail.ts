...
import { UsersRepoReadOneByLoginOrEmailCommand, UsersRepoReadOneByLoginOrEmailUseCase } from "../use-cases/users.repo.readOneByLoginOrEmail.usecase";
...
describe(`${UsersRepoReadOneByLoginOrEmailUseCase.name}: read user`, () => {
    ...
    it('Get user by login', async () => {
        ...
        let createCommand_1 = new UsersRepoCreateUserCommand(new UserControllerRegistrationEntity("userqwe", "special@mail.com", "123123"))
        let createCommand_2 = new UsersRepoCreateUserCommand(new UserControllerRegistrationEntity("user", "notspecial@mail.com", "123123"))
        let createCommand_3 = new UsersRepoCreateUserCommand(new UserControllerRegistrationEntity("bob", "bob@mail.com", "123123"))
        let createCommand_4 = new UsersRepoCreateUserCommand(new UserControllerRegistrationEntity("alice", "alice@mail.com", "123123"))
        ...
        let findUserByLoginCommand = new UsersRepoReadOneByLoginOrEmailCommand(createCommand_1.message.login);
        let findUserByEmailCommand = new UsersRepoReadOneByLoginOrEmailCommand(createCommand_1.message.email);
